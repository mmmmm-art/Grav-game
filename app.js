...
function create ()
{
   ...
   this.anims.create({
    ...
    gameOverText = this.add.text(350, 200, 'Game Over', { fontSize: '100px', fill: '#ffffff' });
    ...
    this.physics.add.collider(beam, bombs);
    this.physics.add.collider(beam, beam);
...
function update ()
{
    ...
    if (this.keys.a.isDown)
    {
        ...
        beam1.setCollideWorldBounds(true);
        beam1.setBounce(1);
    }
    if (this.keys.d.isDown)
    {
        ...
        beam2.setCollideWorldBounds(true);
        beam2.setBounce(1);
    }
    if (this.keys.w.isDown)
    {
        ...
        beam3.setCollideWorldBounds(true);
        beam3.setBounce(1);
    }
    if (this.keys.s.isDown)
    {
        ...
        beam4.setCollideWorldBounds(true);
        beam4.setBounce(1);
    }
    if (this.keys.e.isDown)
    {
        player.x = Math.random() * 900 + 100;
        player.y = Math.random() * 200 + 150;
        hit.active = false;
        hitEnemy.active = false;
    }
